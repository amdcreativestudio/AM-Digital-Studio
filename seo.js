...
console.log(
    "%cFiverr SEO Package System Ready ✓",
...
const revealElements =
    document.querySelectorAll(
        ".seo-service-card, .pricing-card, .why-card, .process-card"
    );
