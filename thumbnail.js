...
console.log(
    "%cAM Digital Studio - Thumbnail Design",
...
// ===============================
// Thumbnail Package Data
// ===============================

const thumbnailPackages = {
...
const revealElements =
    document.querySelectorAll(
        ".thumbnail-service-card, .pricing-card, .why-card, .process-card"
    );
